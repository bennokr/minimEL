...
import minimel
from minimel.mentions import get_matches, setup_matcher, spacy_matcher
...
models = {
    "simple": Model(
        name="Simple English (Mewsli-9 evaluation)",
    ...
    "simple_spacy": Model(
        name="Simple English with Spacy NER (Mewsli-9 evaluation)",
        matcher=spacy_matcher("en_core_web_sm"),
        ned=minimel.MiniNED(
            basedir / "wiki/simplewiki-20211120/index_simplewiki-20211120.dawg"
        ),
        eval=basedir / "evaluation/Mewsli-9/en.tsv",
